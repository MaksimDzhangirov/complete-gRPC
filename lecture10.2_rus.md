...
написать unit тесты, обработать ошибки, коды состояний и задать 
...
Этот конструктор нам пригодится позднее при написании unit теста.
...
Превосходно! Прежде чем я покажу вам как написать unit тесты для этого 
...
Он успешно пройден. Теперь давайте запустим все unit тесты вместе. Если 
...
курса, пригодится вам. Желаю вам получать удовольствие от написания программ 
и до новых встреч!