...
![Протокол-Диффи-Хеллмана](images/ssl-tls-lecture/diffie-hellman1.png)
![Протокол-Диффи-Хеллмана2](images/ssl-tls-lecture/diffie-hellman2.png)
...
![функция-формирования-ключа](images/ssl-tls-lecture/key_derivation_function.png)
...
![Односторонняя-функция-с-потайным-входом](images/ssl-tls-lecture/trapdoor_function.png)
...
![Статический-ключ](images/ssl-tls-lecture/static-key.png)
**Рисунок 10** - Статический ключ.

![Эфемерный-ключ](images/ssl-tls-lecture/ephemeral-key.png)
...
![криптография-на-эллиптических-кривых](images/ssl-tls-lecture/elliptic-curve-cryptography.png)
...
![асимметричная-криптография](images/ssl-tls-lecture/asymmetric_cryptography.png)
...
![асимметричное-шифрование](images/ssl-tls-lecture/asymmetric_encryption.png)
...
![обмен-публичными-ключами](images/ssl-tls-lecture/public-key-sharing.png)
...
![атака-человек-посередине](images/ssl-tls-lecture/man-in-the-middle_attack.png)
...
![цифровой-сертификат](images/ssl-tls-lecture/digital_certificate.png)
![подписывание-сертификата](images/ssl-tls-lecture/certificate_signing.png)
...
![цепочка-доверия](images/ssl-tls-lecture/a_chain_of_trust.png)
...
![цифровая-подпись-1](images/ssl-tls-lecture/digital_signature1.png)
![цифровая-подпись-2](images/ssl-tls-lecture/digital_signature2.png)
...
![приветственное-сообщение-клиента](images/ssl-tls-lecture/tls_handshake_1.png)
...
![ответ-сервера](images/ssl-tls-lecture/tls_handshake_2.png)
...
Здесь поля Server certificate, Certificate verify и Server finish называются
аутентификационными сообщениями, поскольку они используются для аутентификации
сервера. Благодаря подписи и MAC всего рукопожатия TLS 1.3 защищен от 
нескольких типов атак "человек посередине".
...
![вся-последовательность-действий](images/ssl-tls-lecture/tls_handshake_4.png)
...
![возобновление-&-ранее-опубликованный-ключ](images/ssl-tls-lecture/pre-shared-key.png)
**Рисунок 25** - Возобновление & ранее опубликованный ключ.
